...
namespace Bhaptics.Tact.Unity
{
    ...
    public class HapticClipManager : ScriptableObject
    {
        ...
        [MenuItem("bHaptics/[Deprecated] .tact files -> HapticClips", priority = 2)]
        private static void OnClickRefreshAssetFiles()
        {
            RefreshTactFiles();
        }

        [MenuItem("bHaptics/[Deprecated] HapticClips -> .tact files", priority = 2)]
        private static void OnClickExportTactFiles()
        {
            ExportTactFiles(GetAllInstances<FileHapticClip>());
        }
