...
IL_0024:
	{
		...
		NullCheck(L_5);
		VirtualActionInvoker0::Invoke(35 /* System.Void Meta.WitAi.VoiceService::Deactivate() */, L_5);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* TimerController_GetFormattedTimeFromSeconds_m60DD6BC2D15A5C572F1204EE3F8CB71532C14A9A (TimerController_t0FB861D29C95254301A99447879F8DD59515B291* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->____time_4 = ((double)il2cpp_codegen_subtract(L_4, (1.0)));
...
IL_003d:
	{
		...
		double L_9;
		L_9 = TimeSpan_get_TotalHours_m753DFC812CEC8F9214EF5F9839C5B4A4DB0D2883((&V_0), NULL);
		...
		int32_t L_14;
		L_14 = TimeSpan_get_Minutes_m93E37D01CD6DA2DE5B35609D740D322E270B678F((&V_0), NULL);
		int32_t L_15 = L_14;
		...
		int32_t L_22;
		L_22 = TimeSpan_get_Milliseconds_m09D9D6D0033D5FBC62A3C4007CC716A85F4FC8EA((&V_0), NULL);
		double L_23;
		L_23 = floor(((double)((float)(((float)L_22)/(100.0f)))));
		double L_24 = L_23;
